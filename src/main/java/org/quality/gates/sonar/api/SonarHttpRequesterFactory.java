...
class SonarHttpRequesterFactory {
    ...
    private SonarHttpRequesterFactory () {
    }
    ...
    static SonarHttpRequester getSonarHttpRequester (GlobalConfigDataForSonarInstance globalConfigDataForSonarInstance) {
        ...
        try {
            ...
            return getSonarHttpRequesterInstance(sonarVersion);
        } catch (IOException e) {
    ...
    protected static SonarHttpRequester getSonarHttpRequesterInstance (String sonarVersion) {
        ...
        } else if (majorSonarVersion(sonarVersion) >= 6 && majorSonarVersion(sonarVersion) < 8 && minorSonarVersion(sonarVersion) >= 1) {
